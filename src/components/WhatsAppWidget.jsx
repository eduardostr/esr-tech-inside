  ...
  return (
    ...
    >
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-esr-gradient rounded-full flex items-center justify-center flex-shrink-0 shadow-esr-sm">
      ...
      <button
        ...
        className="relative w-14 h-14 sm:w-16 sm:h-16 bg-esr-gradient text-white rounded-full
